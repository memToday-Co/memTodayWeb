...
export default function LandingPage() {
  ...
  const features: Feature[] = [
    {
      title: "Memory Challenge Mode",
      description:
        "Test your memorization skills with timed challenges. View quotes for 10 seconds, then type from memory.",
      icon: <Brain className="h-10 w-10 text-black" />,
    },
    {
      title: "Quote Management",
      description:
        "Store, organize, and manage your favorite quotes with tags and categories for easy access.",
      icon: <BookOpen className="h-10 w-10 text-black" />,
    },
    {
      title: "Progress Tracking",
      description:
        "Monitor your memorization accuracy and improvement over time with detailed analytics.",
      icon: <TrendingUp className="h-10 w-10 text-black" />,
    },
    {
      title: "Distraction-Free Practice",
      description:
        "Clean, minimalist interface designed for focused practice sessions and optimal learning.",
  ...
  const testimonials: Testimonial[] = [
    {
      ...
      content:
        "QuoteMemory has transformed how I memorize important quotes for my literature classes. The memory challenge feature is incredibly effective!",
      avatar: "sarah",
    },
    {
      id: 2,
      ...
      company: "TED Talks",
      content:
        "As a professional speaker, I need to memorize quotes perfectly. This app's progress tracking helps me see exactly where I need to improve.",
      avatar: "michael",
    },
    {
      id: 3,
      ...
      content:
        "The clean interface keeps me focused during practice sessions. I've memorized over 50 quotes in just two months using this app!",
      avatar: "aisha",
    },
  ];
      ...
      <header className="fixed top-0 z-50 w-full border-b border-gray-200 bg-white/95 backdrop-blur supports-[backdrop-filter]:bg-white/60">
        <div className="container flex h-16 items-center justify-between">
          <div className="flex items-center space-x-4">
            ...
            >
              <Quote className="h-6 w-6 mr-2 text-black" />
              QuoteMemory
            </Link>
          </div>
              ...
              <div className="lg:w-1/2 space-y-8">
                <div>
                  ...
                  <h1 className="text-4xl md:text-6xl font-bold tracking-tight">
                    Memorize Quotes Like Never Before
                  </h1>
                </div>
                <p className="text-lg md:text-xl text-gray-600">
                  Store your favorite quotes, challenge your memory with timed
                  exercises, and track your progress as you master the art of
                  memorization.
                </p>
                    ...
                    <div className="space-y-4">
                      <div className="bg-gray-50 p-4 rounded-lg">
                        ...
                        <div className="flex items-center gap-2 text-xs text-gray-500">
                          ...
                          <span>10 seconds to memorize</span>
                        </div>
                      </div>
          ...
          <div className="container px-4 mx-auto">
            <div className="text-center mb-16">
              ...
              <h2 className="text-3xl md:text-4xl font-bold tracking-tight mb-4 text-black">
                Master Any Quote with Confidence
              </h2>
              <p className="text-gray-600 max-w-[700px] mx-auto">
                QuoteMemory provides everything you need to store, practice, and
                master your favorite quotes through interactive challenges and
        ...
        <section className="py-16 md:py-24 bg-white">
          <div className="container px-4 mx-auto">
            <div className="text-center mb-16">
              ...
              <p className="text-gray-600 max-w-[700px] mx-auto">
                Start with our free plan and upgrade as your quote collection
                grows. All plans include memory challenges and progress
                tracking.
              </p>
            </div>
        ...
        <section className="py-16 md:py-24 bg-gray-50">
          <div className="container px-4 mx-auto">
            <div className="text-center mb-16">
              ...
              <p className="text-gray-600 max-w-[700px] mx-auto">
                See what our users have to say about their quote memorization
                journey.
              </p>
            </div>
            ...
            <div className="bg-gradient-to-r from-gray-100 to-white rounded-3xl p-8 md:p-12 shadow-xl border border-gray-200">
              <div className="max-w-3xl mx-auto text-center">
                ...
                <p className="text-lg md:text-xl mb-8 text-gray-600">
                  ...
                  memorization skills with QuoteMemory.
                </p>
        ...
        <div className="container px-4 mx-auto">
          <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
            <div>
              ...
              >
                <Quote className="h-5 w-5 mr-2 text-black" />
                QuoteMemory
              </Link>
              <p className="text-gray-600 mb-4">
                Master the art of memorization with interactive quote challenges
            ...
            <div>
              <h3 className="font-medium text-lg mb-4 text-black">Learning</h3>
              <ul className="space-y-3">
                <li>
                  <Link to="#" className="text-gray-600 hover:text-black">
                    How It Works
          ...
          <div className="flex flex-col md:flex-row justify-between items-center">
            <p className="text-sm text-gray-600">
              © {new Date().getFullYear()} QuoteMemory. All rights reserved.
            </p>
